 ...
 * Reference
 */
$GLOBALS['TL_LANG']['tl_content']['googleplusone_size']['reference']['s']='Klein';
$GLOBALS['TL_LANG']['tl_content']['googleplusone_size']['reference']['m']='Mittel';
$GLOBALS['TL_LANG']['tl_content']['googleplusone_size']['reference']['l']='Gro&szlig;';
$GLOBALS['TL_LANG']['tl_content']['googleplusone_size']['reference']['d']='Standard';

$GLOBALS['TL_LANG']['tl_content']['googleplusone_loading']['reference']['a']='Asynchron';
$GLOBALS['TL_LANG']['tl_content']['googleplusone_loading']['reference']['s']='Synchron';
?>